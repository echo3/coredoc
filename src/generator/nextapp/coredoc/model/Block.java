...
implements Comparable, Node {
    ...
    /**
     * List of child blocks which are structurally contained with this block.
     */
    private List<Block> structureChildList;
    private Map<String, Block> structureChildMap;
    private String declaredName;
    private Module module;
    private Node structureParent;
    private String name;
    private DocComment docComment;
    private List<Block> objectChildList;
    ...
    protected void addObjectChild(Block block) {
        if (objectChildList == null) {
            objectChildList = new ArrayList<Block>();
        }
    ...
    public void addStructureChild(Block block) {
        ...
        if (structureChildList == null) {
            structureChildList = new ArrayList<Block>();
            structureChildMap = new HashMap<String, Block>();
        }
