        ...
        for (int i = 0; i < count; ++i) {
            ...
            if (childBlock instanceof ObjectBlock) {
                ...
                if (fieldBlock.isFunction()) {
                    if ("$load".equals(fieldBlock.getName())) {
                        continue;
                    } else if ("$construct".equals(fieldBlock.getName())) {
                        fieldBlock.addModifier(Modifiers.CONSTRUCTOR);
                    }
                } else {
            ...
            } else if (childBlock instanceof ClassBlock) {
