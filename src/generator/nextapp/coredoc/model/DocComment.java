...
public class DocComment {
    ...
    private Map<String, List<Tag>> tagNameToTagList = new HashMap<String,  List<Tag>>();
    ...
    public void addTag(Tag tag) {
        List<Tag> list = tagNameToTagList.get(tag.getType());
        if (list == null) {
     ...
     */
    public Iterator<Tag> getTags(String type) {
        return tagNameToTagList.containsKey(type) ? tagNameToTagList.get(type).iterator() : null;
    }
